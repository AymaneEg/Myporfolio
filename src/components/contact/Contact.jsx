  ...
  return (
    <div className='w-full min-h-screen flex-col justify-center items-center py-8  flex  bg-customBlack  text-white text-center' id='Contact'>
        ...
        <div className='w-8/12 h-1/2 flex flex-col lg:flex-row gap-4 py-8 '>
           ...
           <a href="mailto: aymanelgenouni10@gmail.com">
              <div className='ContactDiv'>
                    <span>aymanelgenouni10@gmail.com</span>
              </div> 
           </a>

           <a href="https://linkedin.com/in/aymane-el-guanouni-bb684a216">
            <div className='ContactDiv'>
               <span>LinkedIn.com/AymaneEg</span>
            </div>
           </a>

           <a href="https://github.com/AymaneEg">
              <div className='ContactDiv'>
